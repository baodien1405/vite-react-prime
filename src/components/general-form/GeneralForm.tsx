...
export function GeneralForm() {
  ...
  return (
    <form noValidate onSubmit={handleSubmit(handleGeneralSubmit)} className='p-5'>
      <InputTextField
        name='fullName'
        control={control}
        label='Full Name'
      ...
      <InputTextField name='email' control={control} label='Email' placeholder='Email' rootClassName='mb-2' />
      ...
      <InputNumberField name='amount' control={control} label='Amount' placeholder='$100' rootClassName='mb-2' />
      ...
      <InputSwitchField name='tradingOnline' control={control} label='Trading Online' rootClassName='mb-5' />

      <Button type='submit' disabled={isSubmitting} label='Submit' className='w-full' />
    </form>
  )
}
